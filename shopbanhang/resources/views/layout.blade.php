				...
				<div class="row">
					...
					<div class="col-sm-5">
						...
						<div class="search_box pull-right">
							...
							<input type="submit" style="margin-top:0px;color:black;" name="Search Items" class="btn btn-primary btn-sm" value="Search"/>
						</div>
						</form>
					</div>
				</div>
						...
						<div class="panel-group category-products" id="accordian">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{URL::to('/category-home/'.$cate->category_id)}}">
						...
						<div class="brands_products">
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="{{URL::to('/brand-home/'.$brand->brand_id)}}"> <span class="pull-right">(50)</span>{{$brand->brand_name}}</a></li>
									@endforeach
								</ul>
							</div>
						</div>
