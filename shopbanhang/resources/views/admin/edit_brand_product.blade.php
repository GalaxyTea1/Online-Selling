            ...
            <div class="position-center">
                <form role="form" action="{{URL::to('/update-brand-product/'.$edit_value->brand_id)}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$edit_value->brand_name}}" name="brand_product_name" class="form-control" id="exampleInputEmail1" placeholder="Name">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" name="add_brand_product" class="btn btn-info">Update List</button>
                </form>
            </div>
            @endforeach
        </div>
