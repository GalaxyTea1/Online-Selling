...
<div class="product-details">
    ...
    <div class="col-sm-7">
        <div class="product-information">
            ...
            <p><b>List:</b> {{$value->category_name}}</p>
...
<div class="category-tab shop-details-tab">
    ...
    <div class="col-sm-12">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#details" data-toggle="tab">Desc</a></li>
            <li><a href="#companyprofile" data-toggle="tab">Product Details</a></li>

            <li><a href="#reviews" data-toggle="tab">CMT</a></li>
        </ul>
    </div>
...
<div class="recommended_items">
    <!--recommended_items-->
    <h2 class="title text-center">Product Related</h2>
